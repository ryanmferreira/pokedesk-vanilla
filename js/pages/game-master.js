...
import {
    showLoading,
    hideLoading
} from "/js/components/loading.js";

import {
    calculateLevel,
    getMaxHp
} from "/js/pokemon/pokemon-rules.js";

import {
    updateLifeBar
} from "/js/pokemon/pokemon-management.js";
...
const copySessionIdButton =
    document.getElementById("copy-session-id");

const leaveSessionButton =
    document.getElementById("leave-session");

const sessionNameElement =
    document.getElementById("gm-session-name");

const sessionIdElement =
    document.getElementById("gm-session-id");
...
const closeModalButton =
    document.getElementById("close-inspect-modal");

const modalCharName =
    document.getElementById("modal-char-name");

const modalCharInfo =
    document.getElementById("modal-char-info");

const modalCharContent =
    document.getElementById("modal-char-content");
...
const pokemonAttacksModal =
    document.getElementById("pokemon-attacks-modal");

const closePokemonAttacksModalButton =
    document.getElementById(
        "close-pokemon-attacks-modal"
    );

const attacksPokemonName =
    document.getElementById(
        "attacks-pokemon-name"
    );

const attacksPokemonInfo =
    document.getElementById(
        "attacks-pokemon-info"
    );

const pokemonAttacksContent =
    document.getElementById(
        "pokemon-attacks-content"
    );
...
function openPokemonAttacksModal(pokemon) {
    ...
    const attacks =
        Array.isArray(pokemon.attacks)
            ? pokemon.attacks.filter(attack =>
                attack &&
                attack.name &&
                attack.name.trim() !== ""
            )
    ...
    attacksPokemonName.textContent =
        pokemon.species || "Unknown Pokémon";


    attacksPokemonInfo.textContent =
        types || "Unknown Type";
    ...
    pokemonAttacksContent.innerHTML = `
        ...
        <div class="gm-pokemon-summary">
            ...
            <div class="detail-box avatar-box gm-pokemon-image">
                ...
                <img
                    src="${pokemon.imgUrl || "/assets/icons/pokeball.svg"}"
        ...
        <div class="column">
            ...
            <div class="health-bar-container green-bar">
                ...
                <div
                    ...
                    style="width: ${updateLifeBar(pokemon)};">
                </div>
    ...
    pokemonAttacksModal.classList.remove(
        "hidden"
    );
}
...
function openInspectModal(char) {
    ...
    const team =
        Array.isArray(char.team)
            ? char.team
            : [];


    const box =
        Array.isArray(char.box)
            ? char.box
            : [];
    ...
    modalCharContent.innerHTML = `
        ...
        <div class="gm-character-sections">
            ...
            : `
                            ...
                            <div class="pokemon-slot empty-slot">
                                (+) No Pokémon in party
                            </div>
    ...
    const pokemonButtons =
        modalCharContent.querySelectorAll(
            "[data-team-index]"
        );
...
function renderCharacterPokemon(
    pokemon,
    index,
    location
) {
    ...
    return `
        ...
        <button
            type="button"
            class="pokemon-slot active-slot gm-character-pokemon"
...
function renderBoxPokemon(
    ...
    return `
        ...
        <button
            type="button"
            class="captured-item gm-box-pokemon"
...
function closePokemonAttacksModal() {
    ...
    if (pokemonAttacksModal) {
        ...
        pokemonAttacksModal.classList.add(
            "hidden"
        );
            ...
            try {
                ...
                if (
                    ...
                    emptyNotice.innerHTML = `
                        ...
                        <h6>
                            No characters found in this session.
                        </h6>
                ...
                for (
                    ...
                    characterCard.innerHTML = `
                        ...
                        <div
                            class="static-row align-between gm-character-card-header">
                            ...
                            <div class="detail-box column stat-box role-stat-box">
                                ...
                                <span class="panel-value role-text">
                                    ${char.campaignRole || "PLAYER"}
                                </span>
                        ...
                        <div class="action-row">
                            ...
                            <button
                                type="button"
                                class="inspect-btn btn-dark expand">
                                Inspect Character
                            </button>
...
closePokemonAttacksModalButton?.addEventListener(
    "click",
...
inspectModal?.addEventListener(
    "click",
    event => {

        if (
            event.target === inspectModal
        ) {
...
pokemonAttacksModal?.addEventListener(
    "click",
    event => {

        if (
            event.target === pokemonAttacksModal
        ) {
...
document.addEventListener(
    ...
    event => {
        ...
        if (
            !pokemonAttacksModal?.classList.contains(
                "hidden"
            )
        ) {
    ...
    () => {
        ...
        onAuthStateChanged(
            ...
            async user => {
                ...
                greetingsNameElement.textContent =
                    `Hello, ${firstName}!`;
